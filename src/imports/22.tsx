import imgFrame20 from "figma:asset/9ff4feef8e10d3887bd65c1fbafacf567adea4e7.png";
  ...
  return (
    <div className="absolute content-stretch flex flex-col font-['Inter:Bold',sans-serif] font-bold gap-[30px] items-start leading-[normal] left-[51px] not-italic text-black top-[42px] w-[438px]">
      <div className="relative shrink-0 text-[24px] w-full">
        <p className="mb-0">Crushed Stone Classification for</p>
        <p>Quarry Industry</p>
      </div>
      <p className="relative shrink-0 text-[16px] w-full">Use image processing classification adaptation to crushed stone image predictor based on deep learning and intelligently selected features for quarry industry.</p>
    </div>
  );
}
...
function Number() {
  return (
    <div className="absolute bg-black bottom-[86.7%] box-border content-stretch flex gap-[10px] items-center justify-center left-0 px-[11px] py-[13px] right-[95.24%] rounded-[37.5px] top-0" data-name="number">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[40px] text-nowrap text-white whitespace-pre">22</p>
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="absolute bottom-0 left-[49.21%] right-0 rounded-[30px] top-0">
      <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[30px] size-full" src={imgFrame20} />
    </div>
  );
}
...
export default function Component() {
  return (
    <div className="relative size-full" data-name="22">
      <Description />
      <Number />
      <Frame1 />
    </div>
