...
function ContactInput() {
  return (
    <div className="absolute h-[56px] left-[179px] top-[621px] w-[326px]" data-name="contact-input">
      <p className="absolute bottom-[66.07%] font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-0 not-italic right-[60.74%] text-[16px] text-black text-nowrap top-0 whitespace-pre">Name (Required)</p>
      <TextInput />
    </div>
  );
}
...
function ContactInput1() {
  return (
    <div className="absolute h-[56px] left-[555px] top-[621px] w-[515px]" data-name="contact-input">
      <p className="absolute bottom-[66.07%] font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-0 not-italic right-[75.92%] text-[16px] text-black text-nowrap top-0 whitespace-pre">Email (Required)</p>
      <TextInput1 />
    </div>
  );
}
...
function ContactInput2() {
  return (
    <div className="absolute h-[56px] left-[179px] top-[698px] w-[326px]" data-name="contact-input">
      <p className="absolute bottom-[66.07%] font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-0 not-italic right-[59.51%] text-[16px] text-black text-nowrap top-0 whitespace-pre">Phone (Required)</p>
      <TextInput2 />
    </div>
  );
}
...
function ContactInput3() {
  return (
    <div className="absolute h-[56px] left-[555px] top-[698px] w-[515px]" data-name="contact-input">
      <p className="absolute bottom-[66.07%] font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-0 not-italic right-[60.39%] text-[16px] text-black text-nowrap top-0 whitespace-pre">Company Name (Required)</p>
      <TextInput3 />
    </div>
  );
}
...
function TextInput4() {
  return (
    <div className="absolute bg-gray-50 h-[89.396px] left-[179px] top-[808.2px] w-[891px]" data-name="text-input">
      <div aria-hidden="true" className="absolute border border-[#99a1af] border-solid inset-0 pointer-events-none" />
    </div>
  );
}
...
function Group() {
  return (
    <div className="absolute contents left-[179px] top-[775px]">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal h-[24.265px] leading-[normal] left-[179px] not-italic text-[16px] text-black top-[775px] w-[256.5px]">Message (Required)</p>
      <TextInput4 />
    </div>
  );
}
...
export default function Contact() {
  return (
    <div className="relative size-full" data-name="contact">
      ...
      <div className="absolute bg-white h-[1106px] left-[108px] rounded-[30px] top-[259px] w-[1033px]" />
      ...
      <ContactInput3 />
      <Group />
      <div className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[179px] not-italic text-[16px] text-black top-[1002px] w-[891px]">
