import imgFrame9 from "figma:asset/7e63b4b78372c541014f45e219cba5951beae7e5.png";
...
function Frame() {
  return (
    <div className="absolute content-stretch flex flex-col font-['Inter:Bold',sans-serif] font-bold gap-[30px] items-start leading-[normal] left-[51px] not-italic text-black top-[42px] w-[438px]">
      <p className="relative shrink-0 text-[24px] w-full">CMU Move</p>
      <p className="relative shrink-0 text-[16px] w-full">An all-in-one mobile platform designed to connect and engage the Chiang Mai University community. It serves as a central hub for important news and events while promoting an active lifestyle through gamified challenges, such as university-wide step competitions. Users can track their progress in real-time, compete on a leaderboard for rewards, and stay engaged with all campus activities, fostering stronger relationships and a more vibrant university atmosphere.</p>
    </div>
  );
}
...
function Number() {
  return (
    <div className="absolute bg-black bottom-[86.7%] box-border content-stretch flex gap-[10px] items-center justify-center left-0 px-[11px] py-[13px] right-[95.24%] rounded-[37.5px] top-0" data-name="number">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[40px] text-nowrap text-white whitespace-pre">11</p>
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="absolute bottom-0 left-[49.21%] right-0 rounded-[30px] top-0">
      <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[30px] size-full" src={imgFrame9} />
    </div>
  );
}
