import imgFrame10 from "figma:asset/1e50348bc525d0cb1a7b21831b02a4211236bb1a.png";
...
function Frame() {
  return (
    <div className="absolute content-stretch flex flex-col font-['Inter:Bold',sans-serif] font-bold gap-[30px] items-start leading-[normal] left-[51px] not-italic text-black top-[42px] w-[438px]">
      <p className="relative shrink-0 text-[24px] w-full">Home air plus</p>
      <p className="relative shrink-0 text-[16px] w-full">An all-in-one smart dashboard solution for comprehensive building management and control. It allows administrators to monitor and manage various systems in real-time from a single platform, including HVAC control, solar energy production monitoring, CCTV surveillance, and in-depth data analytics for metrics like temperature, humidity, air quality (PM 2.5), and total energy consumption. This system is designed to optimize building management efficiency, reduce energy usage, and maximize security.</p>
    </div>
  );
}
...
function Number() {
  return (
    <div className="absolute bg-black bottom-[86.7%] box-border content-stretch flex gap-[10px] items-center justify-center left-0 px-[11px] py-[13px] right-[95.24%] rounded-[37.5px] top-0" data-name="number">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[40px] text-nowrap text-white whitespace-pre">12</p>
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="absolute bottom-0 left-[49.21%] right-0 rounded-[30px] top-0">
      <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[30px] size-full" src={imgFrame10} />
    </div>
  );
}
