import imgFrame13 from "figma:asset/8b7099822442608da5791d251b86d00b9f4cbf16.png";
...
function Frame() {
  return (
    <div className="absolute content-stretch flex flex-col font-['Inter:Bold',sans-serif] font-bold gap-[30px] items-start leading-[normal] left-[51px] not-italic text-black top-[42px] w-[438px]">
      <p className="relative shrink-0 text-[24px] w-full">Police LPR Phrae</p>
      <p className="relative shrink-0 text-[16px] w-full">An all-in-one solution for vehicle tracking and fleet management that integrates a web-based dashboard with a mobile application. Administrators can monitor the real-time location of all vehicles in their fleet, view vehicle statuses (e.g., parked, moving), and retrieve historical travel routes along with speed data. This system is designed to increase transportation efficiency, enhance asset security, and help operators plan and control vehicle usage with precision.</p>
    </div>
  );
}
...
function Number() {
  return (
    <div className="absolute bg-black bottom-[86.7%] box-border content-stretch flex gap-[10px] items-center justify-center left-0 px-[11px] py-[13px] right-[95.24%] rounded-[37.5px] top-0" data-name="number">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[40px] text-nowrap text-white whitespace-pre">15</p>
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="absolute bottom-0 left-[49.21%] right-0 rounded-[30px] top-0">
      <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[30px] size-full" src={imgFrame13} />
    </div>
  );
}
...
export default function Component() {
  return (
    <div className="relative size-full" data-name="15">
      <Description />
      <Number />
      <Frame1 />
    </div>
